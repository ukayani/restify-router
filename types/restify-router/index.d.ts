...
import { Server, RouteOptions, RequestHandler, RequestHandlerType as RestifyRequestHandlerType } from "restify";

export type RequestHandlerType = RestifyRequestHandlerType | Function;
